...
[![CI](https://github.com/moshejs/digital-decretals/actions/workflows/ci.yml/badge.svg)](https://github.com/moshejs/digital-decretals/actions/workflows/ci.yml)
Code: MIT · Text & data © Edward A. Reno III (see [LICENSE.md](LICENSE.md))
